	...
	while (opend == 0 && stop_thread == 0) {
		...
		if (BASS_Init(0, frequencyvalue + 100, 0, NULL, NULL)) {
			if ((noteoff1value == 0) && (nofxvalue == 0)) {
				hStream[0] = BASS_MIDI_StreamCreate(128, BASS_STREAM_DECODE | (sound_out_float ? BASS_SAMPLE_FLOAT : 0) | (check_sinc() ? BASS_MIDI_SINCINTER : sinc), frequencyvalue + 100);
				BASS_ChannelSetAttribute(hStream[0], BASS_ATTRIB_MIDI_CPU, maxcpu);
			}
			else if ((noteoff1value == 0) && (nofxvalue == 1)) {
				hStream[0] = BASS_MIDI_StreamCreate(16, BASS_STREAM_DECODE | BASS_MIDI_NOFX | (sound_out_float ? BASS_SAMPLE_FLOAT : 0) | (check_sinc() ? BASS_MIDI_SINCINTER : 0), frequencyvalue + 100);
				BASS_ChannelSetAttribute(hStream[0], BASS_ATTRIB_MIDI_CPU, maxcpu);
			}
			else if ((noteoff1value == 1) && (nofxvalue == 0)) {
				hStream[0] = BASS_MIDI_StreamCreate(128, BASS_STREAM_DECODE | BASS_MIDI_NOTEOFF1 | (sound_out_float ? BASS_SAMPLE_FLOAT : 0) | (check_sinc() ? BASS_MIDI_SINCINTER : 0), frequencyvalue + 100);
				BASS_ChannelSetAttribute(hStream[0], BASS_ATTRIB_MIDI_CPU, maxcpu);
			}
			else if ((noteoff1value == 1) && (nofxvalue == 1)) {
				hStream[0] = BASS_MIDI_StreamCreate(128, BASS_STREAM_DECODE | BASS_MIDI_NOFX | BASS_MIDI_NOTEOFF1 | (sound_out_float ? BASS_SAMPLE_FLOAT : 0) | (check_sinc() ? BASS_MIDI_SINCINTER : 0), frequencyvalue + 100);
				BASS_ChannelSetAttribute(hStream[0], BASS_ATTRIB_MIDI_CPU, maxcpu);
			}
			if (!hStream[0]) continue;
			if ((noteoff1value == 0) && (nofxvalue == 0)) {
				hStream[1] = BASS_MIDI_StreamCreate(128, BASS_STREAM_DECODE | (sound_out_float ? BASS_SAMPLE_FLOAT : 0) | (check_sinc() ? BASS_MIDI_SINCINTER : 0), frequencyvalue + 100);
				BASS_ChannelSetAttribute(hStream[1], BASS_ATTRIB_MIDI_CPU, maxcpu);
			}
			else if ((noteoff1value == 0) && (nofxvalue == 1)) {
				hStream[1] = BASS_MIDI_StreamCreate(128, BASS_STREAM_DECODE | BASS_MIDI_NOFX | (sound_out_float ? BASS_SAMPLE_FLOAT : 0) | (check_sinc() ? BASS_MIDI_SINCINTER : 0), frequencyvalue + 100);
				BASS_ChannelSetAttribute(hStream[1], BASS_ATTRIB_MIDI_CPU, maxcpu);
			}
			else if ((noteoff1value == 1) && (nofxvalue == 0)) {
				hStream[1] = BASS_MIDI_StreamCreate(128, BASS_STREAM_DECODE | BASS_MIDI_NOTEOFF1 | (sound_out_float ? BASS_SAMPLE_FLOAT : 0) | (check_sinc() ? BASS_MIDI_SINCINTER : 0), frequencyvalue + 100);
				BASS_ChannelSetAttribute(hStream[1], BASS_ATTRIB_MIDI_CPU, maxcpu);
			}
			else if ((noteoff1value == 1) && (nofxvalue == 1)) {
				hStream[1] = BASS_MIDI_StreamCreate(128, BASS_STREAM_DECODE | BASS_MIDI_NOFX | BASS_MIDI_NOTEOFF1 | (sound_out_float ? BASS_SAMPLE_FLOAT : 0) | (check_sinc() ? BASS_MIDI_SINCINTER : 0), frequencyvalue + 100);
				BASS_ChannelSetAttribute(hStream[1], BASS_ATTRIB_MIDI_CPU, maxcpu);
			}
			if (!hStream[1]) {
